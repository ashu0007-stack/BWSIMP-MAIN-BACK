...
export const getFarmerAttendanceRecords = async (req, res) => {
    try {
...
export const addFarmerAttendanceRecords = async (req, res) => {
  try {
    const { session_id, farmer_id, attended, attendance_date, photo_1, photo_2, remarks } = req.body;
